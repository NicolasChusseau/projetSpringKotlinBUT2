...
```
cd existing_repo
git remote add origin https://gitlab.univ-nantes.fr/E214406A/projetspringkotlin.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.univ-nantes.fr/E214406A/projetspringkotlin/-/settings/integrations)
